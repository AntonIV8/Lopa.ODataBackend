...
namespace IIS.lopa
{
    ...
    public class Paws : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.lopa.Cat.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cat"})]
        public virtual IIS.lopa.Cat Cat
        {
            get
            {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PawsE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PawsE", typeof(IIS.lopa.Paws));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPaws : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.lopa.DetailArrayOfPaws members)

        //  *** End programmer edit section *** (IIS.lopa.DetailArrayOfPaws members)
        ...
        /// </summary>
        public DetailArrayOfPaws(IIS.lopa.Cat fCat) : 
                base(typeof(Paws), ((ICSSoft.STORMNET.DataObject)(fCat)))
        {
        }
        
        public IIS.lopa.Paws this[int index]
        {
            get
            {
                return ((IIS.lopa.Paws)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.lopa.Paws dataobject)
        {
