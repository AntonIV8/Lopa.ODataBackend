...
namespace IIS.lopa
{
    ...
    [View("CatL", new string[] {
            "CatName as \'Cat name\'",
            "Weight as \'Weight\'"})]
    public class Cat : IIS.lopa.Animal
    {
        
        private string fCatName;
        
        private IIS.lopa.DetailArrayOfPaws fPaws;
        ...
        public virtual IIS.lopa.DetailArrayOfPaws Paws
        {
            get
            {
                ...
                if ((this.fPaws == null))
                {
                    this.fPaws = new IIS.lopa.DetailArrayOfPaws(this);
                }
                IIS.lopa.DetailArrayOfPaws result = this.fPaws;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CatE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatE", typeof(IIS.lopa.Cat));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CatL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatL", typeof(IIS.lopa.Cat));
                }
            }
        }
    }
